...
namespace Nt.Scripts.Hosting
{
    public static class Host
    {
        ...
        ///   <list type="bullet">
        ///     <item><description>set the <see cref="IHostEnvironment.ContentRootPath"/> to the result of <see cref="NinjaTrader.Core.Globals.UserDataDir"/></description></item>
        ///     <item><description>set the <see cref="IHostEnvironment.EnvironmentName"/>.</description></item>
        ...
        ///     <item><description>configure the <see cref="Core.Logging.ILoggerFactory"/> to log to the console, debug, and event source output</description></item>
