...
namespace Nt.Scripts.Hosting
{
    public static class HostingHostBuilderExtensions
    {
        ...
        {
            //if (!isInDesignMode) builder.UseContentRoot(NinjaTrader.Core.Globals.UserDataDir);
            //else builder.UseContentRoot(Directory.GetCurrentDirectory());
            ...
            {
                if (!isInDesignMode) services.AddNinjatraderObjects(ninjatraderObjects);
                else services.AddDesignNinjatraderObjects();
            })
