...
namespace Nt.Scripts.Hosting
{
    public static class Hosting
    {
        ...
        public static Nt.Core.Hosting.IHostBuilder CreateNinjascript<T>(T ninjaScript, params object[] ninjatraderObjects)
        {
            ...
            return CreateNinjaDefaultBuilder(builder, ninjaScript, ninjatraderObjects);
        }

        private static Nt.Core.Hosting.IHostBuilder CreateNinjaDefaultBuilder<T>(Nt.Core.Hosting.IHostBuilder builder, T ninjaScript, params object[] ninjatraderObjects)
        {
        ...
        /// </remarks>
        /// <returns>The initialized <see cref="IHostBuilder"/>.</returns>
        public static Nt.Core.Hosting.IHostBuilder CreateNinjaHostBuilder<T>(T ninjaScript, params object[] ninjatraderObjects)
        {
            Nt.Core.Hosting.HostBuilder builder = new Nt.Core.Hosting.HostBuilder();
            string ninjascriptName = TypeNameHelper.GetTypeDisplayName(typeof(T), includeGenericParameters: false, nestedTypeDelimiter: '.');
