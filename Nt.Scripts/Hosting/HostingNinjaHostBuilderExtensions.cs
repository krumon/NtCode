...
{
    public static class HostingNinjaHostBuilderExtensions
    {
        ...
        ///// <param name="ninjatraderObjects">The command line args.</param>
        ///// <returns>The same instance of the <see cref="IHostBuilder"/> for chaining.</returns>
        //public static IHostBuilder NinjaConfigureDefaults(this IHostBuilder builder, string ninjascriptName, object[] ninjatraderObjects)
        //{
        //    builder.UseContentRoot(NinjaTrader.Core.Globals.UserDataDir);
        //    builder.ConfigureHostConfiguration(config =>
        //    {
        ...
        //        options.ValidateOnBuild = isDevelopment;
        //    })
        //    .ConfigureMasterScripts(ninjascriptName, context => { })
        //    .ConfigureNinjascript((context, ninjascriptBuilder) =>
        //    {
        //        ninjascriptBuilder
        //            .AddConfiguration(context.Configuration.GetSection("Ninjascripts"))
