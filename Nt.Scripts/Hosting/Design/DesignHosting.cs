...
{
    public static class DesignHosting
    {
        ...
        public static IHostBuilder CreateDesignNinjaDefaultBuilder()
        {
            HostBuilder builder = new HostBuilder();
            return builder.NinjaDesignConfigureDefaults();
        }
        ...
        /// </remarks>
        /// <returns>The initialized <see cref="IHostBuilder"/>.</returns>
        public static IHostBuilder CreateDesignNinjaDefaultBuilder(string ninjaScriptName)
        {
            HostBuilder builder = new HostBuilder();
            return builder.NinjaDesignConfigureDefaults(ninjaScriptName);
        }
    }
}
