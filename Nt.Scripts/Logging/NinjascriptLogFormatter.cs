...
{
    //public class NinjascriptLogFormatter : NinjascriptFormatter
    //{
    //    private const string LoglevelPadding = ": ";
    //    private readonly IDisposable _optionsReloadToken;
    //    internal NinjascriptLogFormatterOptions FormatterOptions { get; set; }

    //    public NinjascriptLogFormatter(IOptionsMonitor<NinjascriptLogFormatterOptions> options) : base(NinjascriptFormatterNames.Log)
    //    {
    //        if (options == null)
    //            FormatterOptions = new NinjascriptLogFormatterOptions();
    //        else
    //        {
    ...
    //    }
    //    private void ReloadNinjascriptFormatterOptions(NinjascriptLogFormatterOptions options)
    //    {
