...
{
    internal class ServiceProviderEngineScope : IServiceScope, INinjascriptServiceProvider, IAsyncDisposable, IServiceScopeFactory
    {
        ...
        internal NinjascriptServiceProvider RootProvider { get; }
        ...
        public INinjascriptServiceProvider NinjascriptServiceProvider => this;

        #endregion

        #region Constructor

        public ServiceProviderEngineScope(NinjascriptServiceProvider provider, bool isRootScope)
        {
        ...
        public INinjascriptServiceProvider ServiceProvider => throw new NotImplementedException();
