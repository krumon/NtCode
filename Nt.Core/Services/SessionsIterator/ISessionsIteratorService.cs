...
{
    /// <summary>
    /// Represents the properties and methods to create a default implementation of <see cref="SessionsIteratorService"/>.
    /// </summary>
    public interface ISessionsIteratorService : IHostedService, IOnBarUpdateService, IOnMarketDataService, IOnSessionUpdateService
    {
