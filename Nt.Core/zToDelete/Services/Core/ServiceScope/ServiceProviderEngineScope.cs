...
{
    public class ServiceProviderEngineScope : IServiceScope, INinjascriptServiceProvider, IAsyncDisposable, IServiceScopeFactory
    {
        ...
        public INinjascriptServiceProvider ServiceProvider => this;
