...
namespace NtCore
{
    ...
    /// </summary>
    public static class TradingTimeZoneHelpers
    {
        /// <summary>
        /// Method to convert the <see cref="TradingHourType"/> to <see cref="TimeZoneInfo"/>.
        /// </summary>
        /// <param name="tradingTimeZoneName"></param>
        /// <returns><see cref="TimeZoneInfo"/> of the <see cref="TradingHourType"/>.</returns>
        /// <exception cref="Exception"></exception>
        public static TimeZoneInfo ToTimeZoneInfo(this TradingTimeZoneType tradingTimeZoneName)
        {

            //switch (tradingTimeZoneName)
            //{
        ...
        /// <exception cref="Exception"></exception>
        public static TimeSpan ToTimeSpan(this TradingTimeZoneType tradingTimeZoneName)
        {
            //switch (tradingTimeZoneName)
            //{
            //    case (TradingHourType.American_Open):
