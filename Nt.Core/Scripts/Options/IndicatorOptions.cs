...
namespace Nt.Core
{
    ...
    /// </summary>
    public class IndicatorOptions<T> : ScriptOptions<T>
        where T : IndicatorOptions<T>, new()
    {
        ...
        public virtual void CopyTo(IndicatorBase ninjascript)
        {
            CopyTo(ninjascript as NinjaScriptBase);
            ninjascript.IsOverlay = IsOverlay;
            ninjascript.DisplayInDataBox = DisplayInDataBox;
            ninjascript.ScaleJustification = ScaleJustification;
