...
namespace Nt.Core
{
    ...
    /// </summary>
    public abstract class BaseIndicator<TScript, TOptions, TProperties> : BaseScript<BaseIndicator<TScript, TOptions, TProperties>, TOptions,IndicatorProperties>
        where TScript : BaseIndicator<TScript, TOptions, TProperties>
        where TOptions : IndicatorOptions<TOptions>, new()
