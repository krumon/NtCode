...
namespace Nt.Core
{
    ...
    public abstract class BaseScriptsManager<TScript, TOptions, TManagerScript, TManagerOptions> : BaseScript<TScript,TOptions>
        where TScript : BaseScript<TScript, TOptions>, new()
        where TOptions : BaseScriptOptions<TOptions>, new()
        where TManagerScript : BaseScriptsManager<TScript, TOptions, TManagerScript, TManagerOptions>, new()
