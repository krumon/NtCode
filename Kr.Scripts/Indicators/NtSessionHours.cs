...
namespace Ninjascripts
{
    ...
    /// </summary>
    public class NtSessionHours : NsSessionHours
    {
        ...
        public NtSessionHours(NinjaScriptBase ninjascript, SessionIterator sessionIterator, Bars bars):base(ninjascript,sessionIterator,bars)
        {
